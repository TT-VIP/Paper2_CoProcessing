...
class MasterProblem:
    ...
    def __init__(self, instance: InstanceData):
        ...
        self._kkt_duals = []  # List to store dual variable values for each added KKT OC block
    ...
    def _add_kkt_oc_block(self, x_ck_fixed: Dict[Tuple[int, int], int]) -> int:
        ...
        self._kkt_duals.extend([lam_F3, lam_F4, lam_F5, pi_q_cf, pi_q_scw, pi_r_sw])  # store dual variables for stabilization in lexicographic objective
