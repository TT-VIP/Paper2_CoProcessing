...
from Instances.instance_generator import read_instanceData_from_json, read_instance_metadata_from_json
...
if __name__ == "__main__":
    ...
    solver_time_limit = 2000     # Time limit for solving MP and SPs (in seconds)
    ...
    run_yue_decomposition(Verbose=True, solver_time_limit=solver_time_limit, mip_gap=mip_gap, Xi=Xi, max_iterations=max_iterations, instance=instance)