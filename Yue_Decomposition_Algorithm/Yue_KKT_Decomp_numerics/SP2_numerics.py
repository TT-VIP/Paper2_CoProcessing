...
from .SP1_numerics import SubProblem1Solution
...
class SubProblem2:
    ...
    def _add_constraints(self) -> None:
        ...
        m.addConstr(
            gp.quicksum(self.q_scw[s,c,w] * gp.quicksum((data.phi_wh[w][h] / budget_mun_scale) * self.z_wh[w,h] for h in data.H) for s in data.S for c in data.C for w in data.W) <= data.budget_municipality / budget_mun_scale,
